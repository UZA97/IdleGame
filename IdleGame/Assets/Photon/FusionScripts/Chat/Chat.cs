...
public class Chat : MonoBehaviour, IEnhancedScrollerDelegate
{
    ...
    public void Init()
    {
        ...
        _data = new List<Data>
            {
                new Data() { cellType = Data.CellType.Spacer }
            };
    ...
    /// </summary>
    // public void SendButton_Click(string str)
    // {
    //     // add a chat row from us
    //     AddNewRow(Data.CellType.MyText, str);
    ...
    // /// </summary>
    // public void OtherSendButton_Click(string str)
    // {
    //     // add a chat row from another person
    //     AddNewRow(Data.CellType.OtherText, str);
